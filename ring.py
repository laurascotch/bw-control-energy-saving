...
def testBandwidth():
    ...
    s6 = net.addSwitch( 's6', dpid="6", protocols="OpenFlow13", cls=OVSKernelSwitch)#, failMode='standalone', stp=True)
    ...
    info(net['s6'].cmd("ovs-vsctl set Bridge s6 protocols=OpenFlow13"))
    info(net['s6'].cmd("ovs-vsctl set-manager ptcp:6632"))
