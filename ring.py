...
def testBandwidth():
    ...
    net.addLink( server, s1)#, cls=TCLink, delay='1ms', bw=1000 )
    net.addLink( h1, s3)#, cls=TCLink, delay='10ms', bw=100 )
    net.addLink( h2, s3)#,  cls=TCLink, delay='10ms', bw=100 )
    net.addLink( h3, s3)#,  cls=TCLink, delay='10ms', bw=100 )
    net.addLink( h4, s4)#,  cls=TCLink, delay='10ms', bw=100 )
    net.addLink( h5, s4)#,  cls=TCLink, delay='10ms', bw=100 )
    net.addLink( h6, s5)#,  cls=TCLink, delay='10ms', bw=100 )
    net.addLink( h7, s5)#,  cls=TCLink, delay='10ms', bw=100 )
